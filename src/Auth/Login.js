      ...
      <div className="relative z-10 w-full max-w-[420px] overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_24px_80px_rgba(24,24,27,0.18)]">
        <div className="px-9 pb-8 pt-8">
          ...
          <button
            ...
            className="relative mb-2 flex h-9 w-full items-center justify-center gap-3 rounded-lg border border-zinc-200 bg-white text-sm font-medium text-zinc-700 shadow-sm transition hover:bg-zinc-50"
          >
