...
const WebhookNode = ({ data, selected }) => {
  return (
    <div className="relative">
      ...
      {/* 🔥 Running Indicator (above node) */}
      {data.executing && (
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 
                        text-xs font-medium text-blue-600 animate-pulse">
          Running…
        </div>
      )}
      ...
      <div
        className={`
          ...
          ${
            data.executing
              ? "ring-4 ring-blue-400 shadow-lg shadow-blue-300 animate-pulse"
              : ""
          }
        `}
        style={{
          boxShadow: selected
            ? `0 4px 15px rgba(255, 105, 97, 0.3)`
      ...
      >
        <div className="flex items-start gap-4">
          <div
            ...
            style={{ backgroundColor: ACCENT_BG }}
          >
            <Zap size={20} style={{ color: ACCENT_COLOR }} />
          </div>
        ...
        <div className="absolute top-2 right-2 flex gap-1">
          <button
            ...
            className="
              w-7 h-7 border rounded-md flex items-center justify-center 
        ...
        <button
          ...
          className="
            ...
            hover:bg-gray-100 hover:scale-[1.15] transition-all z-10
          "
          title="Add Module"
        >
          <Plus size={14} className="text-gray-600" />
        ...
        <Handle
          ...
          position={Position.Bottom}
          id="a"
          className="!w-4 !h-2 !rounded-full !bg-gray-300 !border-2 !border-white hover:!bg-[#FF6961]"
          style={{ bottom: -10 }}
        />
        <Handle
          type="target"
