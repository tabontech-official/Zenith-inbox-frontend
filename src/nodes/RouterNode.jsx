...
import React from "react";
import { Handle } from "reactflow";
import { GitBranch, Eye, X, Plus } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mt-2">
        ...
        {/* Icon Box */}
        <div className="w-12 h-12 rounded-xl bg-[#e5f6ec] flex items-center justify-center shadow-inner">
          <GitBranch size={26} className="text-[#3d9c61]" />
        </div>

        {/* Title + Description */}
        <div className="leading-tight">
          <h3 className="text-[17px] font-semibold text-gray-800">Router</h3>

          <p className="text-[13px] text-gray-500 mt-[3px]">
            Split paths into branches
          </p>
        </div>
