...
const Organization = () => {
  ...
  const statCards = [
    { label: "Total Emails", value: stats.total, color: "bg-blue-50 text-blue-700 border border-blue-100" },
    { label: "Processed", value: stats.processed, color: "bg-green-50 text-green-700 border border-green-100" },
    { label: "Partial", value: stats.partial, color: "bg-yellow-50 text-yellow-700 border border-yellow-100" },
    { label: "Failed", value: stats.failed, color: "bg-red-50 text-red-700 border border-red-100" },
    { label: "Pending", value: stats.pending, color: "bg-gray-50 text-gray-700 border border-gray-200" },
  ];
      ...
      <main className="flex-1 md:ml-64 p-8 overflow-auto">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
          {statCards.map((item, i) => (
            <motion.div
              key={i}
              className={`rounded-lg p-6 text-center shadow-sm hover:shadow-md transition ${item.color}`}
          ...
          >
            ...
            <div className="flex flex-col space-y-3">
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#4F46E5] text-white py-2 rounded-lg font-medium hover:bg-[#4338CA] transition"
              >
                <FiMail /> Connect another inbox
              </button>
              <button
