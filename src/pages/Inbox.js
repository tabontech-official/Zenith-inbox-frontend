      ...
      >
        <div className="flex justify-between items-start mb-2">
          <div>
            ...
            <p className="text-xs text-gray-500 break-all m-0">
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <main className="flex-1  flex h-screen overflow-hidden">
        {" "}
        <div className="flex w-full md:ml-64 bg-white m-4 rounded-xl shadow-md overflow-hidden h-full">
          <div
            className={`${
              isMobileView && selectedEmail ? "hidden" : "block"
            } w-[380px] min-w-[380px] border-r bg-gray-50 overflow-y-scroll h-full`}
          >
            <div className="p-4 border-b bg-white sticky top-0 z-10 flex-shrink-0">
              <h2 className="text-lg font-semibold text-gray-800 m-0">Inbox</h2>
              <p className="text-xs text-gray-500 m-0">Your synced emails</p>
            </div>
                ...
                {emails.map((email) => {
                  ...
                  return (
                    <li
                      ...
                      className={`h-[88px] p-4 border-b cursor-pointer transition flex flex-col justify-center
                        ${
                          isSelected
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <p
                          className={`text-sm truncate whitespace-nowrap overflow-hidden text-ellipsis m-0 ${
          ...
          {selectedEmail && (
            <div className="flex-1 p-6 overflow-y-scroll bg-gray-50">
              ...
              <div className="border-b pb-4 mb-6">
                <h3 className="text-xl font-semibold text-gray-900 break-words m-0">
