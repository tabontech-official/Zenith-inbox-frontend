...
export default function Template() {
  ...
  <div className="flex">
    ...
    <div className="flex-1 min-h-screen lg:ml-64 relative">
  ...
  ></div>
          ...
          <span
            className={`text-xs font-bold ${
              globalActive ? "text-green-700" : "text-gray-700"
            }`}
          >
            {globalActive ? "ON" : "OFF"}
          </span>
      ...
      <div
        className="
          flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between
          px-4 sm:px-8 py-4 
          bg-white/40 backdrop-blur-xl
          border-b border-white/60 
          shadow-inner
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 gap-2">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              onChange={(e) => setSelectedServiceFilter(e.target.value)}
              className="
                border border-gray-400 rounded-lg px-3 py-1 text-sm
                bg-white/70 backdrop-blur-xl text-gray-900 
        ...
        {viewType && (
          <div
            className="
              bg-indigo-100 backdrop-blur-xl
      ...
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        >
            ...
            <table className="min-w-full text-sm">
              ...
              <thead
                className="
                  ...
                  border-b border-white/60
                  text-gray-900 uppercase text-xs font-semibold
                "
              >
                <tr>
                  {[
                    ...
                    <th
                      key={h}
                      className="p-3 text-left text-gray-800 tracking-wide"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody>
                {loading ? (
                  ...
                  Object.entries(groupedTemplates).map(([srv, group]) => (
                    <React.Fragment key={srv}>
                      {/* Group Row */}
                      <tr className="bg-white/40 backdrop-blur-xl border-b border-white/40">
                        <td
                          colSpan="5"
                      ...
                      {group.map((t) => (
                        <tr
                          ...
                          "
                        >
                          <td className="p-3 text-gray-900">{t.service}</td>
                          ...
                          <td className="p-3 text-center">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                              ...
                              <div
                                className="
                                  w-11 h-6 bg-white/60 border border-white/80 
                                  rounded-full peer-checked:bg-green-400 
                                  transition
                                "
                              ></div>
                              <div
                  ...
                  <tr>
                    <td colSpan="5" className="p-6 text-center text-gray-700">
                      No templates found
                    </td>
                  </tr>
                )}
          ...
          {/* MOBILE CARDS (GLASS) */}
          <div className="sm:hidden divide-y divide-white/60">
            {loading ? (
              <Loader />
            ) : Object.keys(groupedTemplates).length > 0 ? (
              Object.entries(groupedTemplates).map(([srv, group]) => (
                <div key={srv} className="bg-white/40 backdrop-blur-xl">
                  {/* Title */}
                  <h3
                    className="
                      px-4 py-2 font-semibold text-gray-900
                      bg-white/50 backdrop-blur-xl border-b border-white/60
                    "
                  >
                    {srv}
                  </h3>
                  ...
                  {group.map((t) => (
                    <div
                      key={t._id}
                      className="
                        p-4 bg-white/40 backdrop-blur-xl
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-700 mt-2 truncate">
                        {t.content.replace(/<[^>]+>/g, "").slice(0, 110)}...
                      </p>
                      ...
                      <div className="flex justify-between items-center mt-3">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          <div
                            className="
                              w-10 h-5 rounded-full bg-white/60 border border-white/70
      ...
      {/* DRAWER (unchanged — stays native, not glass) */}
      {/** DO NOT TOUCH - KEEP SAME **/}
      {/* ----------------------------------------- */}
      {/* Everything inside drawer stays exactly the same */}
      {/* ----------------------------------------- */}
