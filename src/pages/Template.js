...
//   const [keywords, setKeywords] = useState([{ key: "", operator: "equals" }]);
...
//   const addKeyword = () =>
//     setKeywords([...keywords, { key: "", operator: "equals" }]);
...
//     setKeywords(template.keywords || [{ key: "", operator: "equals" }]);
...
//     try {
//       const userId = localStorage.getItem("userid");
//       const payload = { userId, platform, service, keywords, content };
...
//       setPlatform("");
//       setService("");
//       setKeywords([{ key: "", operator: "equals" }]);
//       setContent("");
...
//               setIsDrawerOpen(true);
//             }}
//             className="px-6 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium hover:opacity-90 transition"
//           >
//             + Create Template
//           </button>
//         </header>
...
//                 <tr>
//                   <th className="p-3 text-left text-base font-medium text-gray-700 tracking-wide">
//                     Type
//                   </th>
//                   <th className="p-3 text-left text-base font-medium text-gray-700 tracking-wide">
//                     Service
...
//                     Template (Preview)
//                   </th>
//                   <th className="p-3 text-center text-base font-medium text-gray-700 tracking-wide">
//                     Active
//                   </th>
//                   <th className="p-3 text-center text-base font-medium text-gray-700 tracking-wide">
//                     Actions
...
//                       value={kw.key}
//                       onChange={(e) =>
//                         updateKeyword(index, "key", e.target.value)
//                       }
//                       placeholder="Keyword (e.g. domain)"
//                       className="flex-1 p-2 border rounded-lg"
//                     />
//                     <select
//                       value={kw.operator}
//                       onChange={(e) =>
//                         updateKeyword(index, "operator", e.target.value)
//                       }
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <table className="w-full border-collapse">
              <thead className="bg-gray-100 border-b">
                <tr>
                  {["Type", "Service", "Keywords", "Template", "Active", "Actions"].map((h) => (
                    <th
                      key={h}
