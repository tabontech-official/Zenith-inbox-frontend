          ...
          <AnimatePresence mode="wait">
            {alert.message && (
              <motion.div
                ...
                className={\bsolute top-0 left-4 right-4 sm:left-8 sm:right-8 z-20 px-3 py-2 rounded-lg text-xs sm:text-sm font-medium text-center backdrop-blur-xl shadow-sm border \\}
              >
                {alert.message}
              </motion.div>
            )}
            ...
            >
              ...
              <div className="w-full max-w-sm bg-white/60 rounded-xl p-3 sm:p-4 border border-white/80 shadow-sm text-left mb-5">
                ...
                <div className="space-y-2.5 text-[11px] sm:text-xs text-gray-700 font-medium">
                  ...
                  <label className={\lex items-center gap-2 \\}>
                    <input
                      type="radio"
                      name="provider"
              ...
              <button
                ...
                onClick={() => setStep(3)}
                className={\lex items-center justify-center gap-2 px-6 py-2.5 rounded-full text-xs sm:text-sm font-semibold transition-all w-full max-w-sm \\}
              >
                <span>Continue</span>
                <FiArrowRight />
              </button>
                    ...
                    {!validationSuccess ? (
                      <div className="w-full">
                        ...
                        <button
                          ...
                          className={\w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-xs font-bold text-white transition-all shadow-sm \\}
                        >
