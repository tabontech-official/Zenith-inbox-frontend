...
path = "C:/react apps/Replex Engine/Zenith-inbox-frontend/src/component/MailhookConnectionModal.js"
with open(path, "r", encoding="utf-8") as f:
    code = f.read()

lines = code.split("\n")
# The return statement starts around line 377. We need to keep lines 0 to 376.
# Wait, let's just slice it securely.
split_str = "  if (!isOpen) return null;"
parts = code.split(split_str)

new_return = split_str + """
